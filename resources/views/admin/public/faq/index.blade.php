            ...
            <div class="table-section">
                ...
                <div class="filter-container">
                    <div class="filter-header">
                        <div style="margin: 18px 0 8px 0;">
                            ...
                            <p style="color: #475569; font-size: 0.85em; margin-bottom: 7px;">
                                 Use the advanced filters below to quickly locate specific FAQ records by status, date, or keyword.
                            </p>
                        </div>
                    ...
                    <div style="display: flex; align-items: center; gap: 15px; flex-wrap: wrap;">
                        <div class="custom-dropdown">
                            <form method="GET" action="{{ route('faqs.index') }}" class="custom-dropdown"
                        ...
                        <form method="GET" action="{{ route('faqs.index') }}" class="filter-search-form"
                    ...
                    <div
                        ...
                        <div>
                            <div style="margin: 18px 0 8px 0;">
                                ...
                                <p style="color: #475569; font-size: 0.85em; margin-bottom: 7px;">
                                    Use the table controls below to show or hide columns, making it easy to customize your view and focus on the FAQ details that matter most to you.
                                </p>
                            </div>
                            ...
                            <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                                ...
                                <span class="badge"
                                    style="display: flex; align-items: center; gap: 5px; background: #f1f5f9; color: #6366f1; border-radius: 12px; padding: 6px 12px; font-size: 0.9em; font-weight: 500;">
                                    <input type="checkbox" id="showQuestion" checked onchange="toggleColumn('question')" style="margin: 0;">
                                    <label for="showQuestion" style="margin-left: 5px; cursor:pointer;">Question/Answer</label>
                                </span>
                                <span class="badge"
                                    style="display: flex; align-items: center; gap: 5px; background: #f1f5f9; color: #6366f1; border-radius: 12px; padding: 6px 12px; font-size: 0.9em; font-weight: 500;">
                ...
                <div id="table-content" class="table-container" style="display: none;">
                    <table class="data-table">
                        <thead>
                            <tr>
                                ...
                                <th data-col="question">Question/Answer</th>
                            ...
                            @if($faqs->isEmpty())
                                <tr>
                                    <td colspan="5" style="text-align: center; padding: 30px; color: #888;">
                                        ...
                                        <div style="margin-top: 8px;">No FAQs found.</div>
                                    </td>
                                </tr>
                            @else
                                @foreach($faqs as $faq)
                                    <tr>
                                        ...
                                        <td data-col="question" style="max-width: 300px; word-break: break-word;">
                                            <div class="employee-info">                                              
                                                <div>
                                                    <h4 style="font-size: 1em; margin: 0;">{!! Str::limit(strip_tags($faq->question), 50) !!}</h4>
                                        ...
                                        <td data-col="status">
                                            <span class="status-badge"
                                                style="background: {{ $faq->is_active ? '#4CAF50' : '#F44336' }}; color: #fff; padding: 4px 12px; border-radius: 12px; font-size: 0.95em;">
                                        ...
                                        <td data-col="actions">
                                            <div class="action-buttons">
                                                <a href="{{ route('faqs.edit', $faq->id) }}" class="action-btn edit">
                    ...
                    <div id="pagination-container">
                        @include('layouts.custom_pagination', ['paginator' => $faqs])
                    </div>
                </div>
            </div>
        </div>
