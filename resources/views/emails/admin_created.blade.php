...
<head>
    <meta charset="UTF-8">
    <title>Welcome to MFS Admin Panel</title>
    <style>
        body {
...
<body>
    <div class="email-wrapper">
        ...
        <div class="content">
            <h2>Hello {{ $name ?? $admin->name ?? '' }},</h2>
            <p style="font-size: 1.08rem; color: #333; margin-bottom: 0.7em;">
                Congratulations! Your <strong>administrator account</strong> for <strong>MFS</strong> has been <span style="color:#2563eb;font-weight:600;">successfully created</span>.
            </p>

            <div class="info-box">
                <div class="info-row">
                    <span class="info-label">Admin Email:</span>
                    <span class="info-value">{{ $email ?? $admin->email ?? '' }}</span>
                </div>
                <div class="info-row">
                ...
                <div class="warning">
                    ...
                    As an admin, you have elevated privileges. Please keep your credentials secure and do not share them with anyone.
                </div>
            </div>
